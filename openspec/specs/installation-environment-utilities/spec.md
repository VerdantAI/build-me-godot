# installation-environment-utilities Specification

## Purpose
TBD - created by archiving change conform-field-engineer-meshes-to-image-reference. Update Purpose after archive.
## Requirements
...
license records, and verification.
...
- **THEN** the report includes stable check IDs for required node classes,
  model artifacts, command paths, license records, and expected output formats
...
- **GIVEN** a promoted provider is missing required ComfyUI nodes or model
  artifacts
